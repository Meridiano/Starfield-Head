...
+ Более приятный интерфейс.
    ...
    + Для подробного интерфейса - [моды m8r98a4f2](https://www.nexusmods.com/starfield/users/13457320?tab=user+files) из серии StarUI.
        ...
        + Есть временные фиксы от сторонних авторов: [StarUI HUD Fix (LilElsia)](Списки-модов/StarUI-HUD-09-June-2024-Fix.zip) и [StarUI Ship Builder Workaround](https://www.nexusmods.com/starfield/mods/9336).
...
+ Текстуры высокого разрешения.
	...
	+ [Real Water HD 2](https://www.nexusmods.com/starfield/mods/10289) и вообще [моды luxor8071](https://next.nexusmods.com/profile/luxor8071/mods?gameId=4187), особенно [Starfield HD Overhaul](https://www.nexusmods.com/starfield/mods/5124).
