...
+ Более приятный интерфейс.
    ...
    + Для подробного интерфейса - [моды m8r98a4f2](https://www.nexusmods.com/starfield/users/13457320?tab=user+files) из серии StarUI.
        ...
        + Есть временные фиксы от сторонних авторов: [StarUI HUD Patch](https://www.nexusmods.com/starfield/mods/11116) и [StarUI Ship Builder Workaround](https://www.nexusmods.com/starfield/mods/9336).
