...
+ [Champollion](https://github.com/Orvid/Champollion/releases) и [Caprica](https://github.com/Orvid/Caprica/actions) - для работы со скриптами.
+ [Notepad++](https://notepad-plus-plus.org/downloads/) - простейший текстовой редактор с подсветкой синтаксиса.
+ [Mega:Share](https://link.meridiano-web.com/mega:share) / Modding / TexConv-Wrapper.zip - для конвертации текстур.
...
9. Для проверки работы написанного скрипта запустите игру, загрузите любое сохранение и используйте следующую команду:
```
